 ...
 */
final class Version20220910123711 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE specialites DROP speciality_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE specialites ADD speciality_id INT NOT NULL');
    }
}
